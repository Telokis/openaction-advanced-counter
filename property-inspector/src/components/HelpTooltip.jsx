const HelpTooltip = ({ children }) => {
  return (
    <div class="relative inline group">
      ...
      <div class="invisible opacity-0 group-hover:visible group-hover:opacity-100 transition-all duration-200 absolute left-1/2 transform -translate-x-1/2 top-full mt-2 w-64 bg-gray-800 text-gray-200 text-sm rounded-lg p-3 shadow-xl/80 border border-steel-200 z-50 text-left">
